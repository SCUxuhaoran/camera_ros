...
int main()
{
    ...
    while (1)
    {
        cout << setiosflags(ios::fixed) << setprecision(1) << visual_result.landmark_id<<"--[2]"<< visual_result.visual_theta << "--[3]" << visual_result.visual_x << "--[4]" << visual_result.visual_y << "--[5]" << uwb_result.x << "--[6]" << uwb_result.y << "--[7]" << radius[0] << "--[8]" << radius[1] << "--[9]" << radius[2] << "--[10]" << radius[3] << endl;
        outFile << setiosflags(ios::fixed) << setprecision(1) << visual_result.landmark_id<<","<< visual_result.visual_theta << "," << visual_result.visual_x << "," << visual_result.visual_y << "," << uwb_result.x << "," << uwb_result.y << "," << radius[0] << "," << radius[1] << "," << radius[2] << "," << radius[3] << endl;
